...
predictor = dlib.shape_predictor('C:/Users/tmdgh/PycharmProjects/FacialAsymmetry/shape_predictor_68_face_landmarks.dat')


# create VideoCapture object (input the video)
# 0 for web camera
#vid_in = cv2.imread('C:/Users/tmdgh/PycharmProjects/FacialAsymmetry/test.jpg', cv2.IMREAD_COLOR)
# "---" for the video file
vid_in = cv2.VideoCapture("C:/Users/tmdgh/PycharmProjects/FacialAsymmetry/test.mp4")
